...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
    ...
    /**
     * @description The requesting user needs to be a center and can only delete prescriptions of related professionals. It is configurable to delete prescriptions without triggering a notification.
     *
     * @tags Prescriptions
     * @name V2PrescriptionsCenterDelete
     * @summary Deletes a prescription by its ID and by a center user.
     * @request DELETE:/api/v2/prescriptions/{prescriptionId}/center
     * @secure
     */
    v2PrescriptionsCenterDelete: (
      prescriptionId: number,
      query: {
        /** If a notification should be triggered. */
        triggerNotification: boolean;
      },
      params: RequestParams = {},
    ) =>
      this.request<void, void>({
        path: `/api/v2/prescriptions/${prescriptionId}/center`,
        method: "DELETE",
        query: query,
        secure: true,
        ...params,
    ...
    /**
     * @description The requesting user must either be the patient, the professional or the center of the prescription, else an Unauthorized-Exception will be thrown
     *
     * @tags Prescriptions
     * @name V2PrescriptionsDetail
     * @summary Gets a prescription by its ID.
