...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @secure
     */
    v1NewsIsAdminPartialUpdate: (data: PatchIsAdminNewsRequest, params: RequestParams = {}) =>
      this.request<void, void>({
     ...
     * @secure
     */
    v1NewsIsSponsoredPartialUpdate: (data: PatchIsSponsoredNewsRequest, params: RequestParams = {}) =>
      this.request<void, void>({
