...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @secure
     */
    v1MeetingCenterDelete: (meetingId: number, schedulingUserId: number, params: RequestParams = {}) =>
     ...
     * @secure
     */
    v1SchedulingUsersProfessionalsDetail: (id: string, params: RequestParams = {}) =>
